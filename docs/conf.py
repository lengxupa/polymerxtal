...
htmlhelp_basename = 'polymerxtaldoc'
...
latex_documents = [
    (master_doc, 'polymerxtal.tex', 'polymerXtal Documentation',
     'polymerxtal', 'manual'),
]
...
man_pages = [
    (master_doc, 'polymerxtal', 'polymerXtal Documentation',
     [author], 1)
]
