...
def getDihstypes(dihs, atoms, atomtypes):
    ...
    for i in range(len(dihstypes)):
        ...
        if (atom1type[2:3] != "2" and atom1type[2:3] != "R") or (
            atom2type[2:3] not in ["2", "R"]
        ):
            atom1type = "X"
        if (atom4type[2:3] != "2" and atom4type[2:3] != "R") or (
            atom3type[2:3] not in ["2", "R"]
        ):
            atom4type = "X"
    ...
    for i in range(ndihs):
        ...
        if (atom3type[2:3] != "2" and atom3type[2:3] != "R") or (
            atom1type[2:3] not in ["2", "R"]
        ):
            atom3type = "X"
        if (atom4type[2:3] != "2" and atom4type[2:3] != "R") or (
            atom2type[2:3] not in ["2", "R"]
